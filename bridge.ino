...
void bridge_startup() {
  int speedStep = ((STARTUP_SPEED_MAX - STARTUP_SPEED_MIN) / STARTUP_SWEEP_MILLIS) * (currentMillis - startupMillis) * 2;
  int rpmStep = ((STARTUP_RPM_MAX - STARTUP_RPM_MIN) / STARTUP_SWEEP_MILLIS) * (currentMillis - startupMillis) * 2;
